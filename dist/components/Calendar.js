...
var Calendar = function (_PureComponent) {
  ...
  _createClass(Calendar, [{
    ...
    value: function handleScroll() {
      ...
      setTimeout(function () {
        var visibleMonths = _this3.list.getVisibleRange();
        // prevent scroll jump with wrong visible value
        if (visibleMonths[0] === undefined) return;
        var visibleMonth = (0, _addMonths2.default)(minDate, visibleMonths[0] || 0);
        var isFocusedToDifferent = !(0, _isSameMonth2.default)(visibleMonth, _this3.state.focusedDate);
        if (isFocusedToDifferent) {
          _this3.setState({ focusedDate: visibleMonth });
    ...
    value: function renderWeekdays() {
      ...
      return _react2.default.createElement(
        ...
        (0, _eachDayOfInterval2.default)({
          ...
          return _react2.default.createElement(
            'span',
            { className: _this4.styles.weekDay, key: i },
            (0, _format2.default)(day, 'ddd', _this4.dateOptions)
          );
        })
      );
    }
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', {
                ...
                readOnly: true,
                value: _this5.formatDateDisplay(range.startDate, 'Early')
              })
            ),
            _react2.default.createElement(
              'span',
              ...
              _react2.default.createElement('input', {
                disabled: range.disabled,
                readOnly: true,
                value: _this5.formatDateDisplay(range.endDate, 'Continuous')
              })
            )
          );
        })
